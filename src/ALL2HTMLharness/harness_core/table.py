...
class PDF_TAB_API_MAP():
    ...
    def create_tab(self, tableID) :
        ...
        self.template.write("for (unsigned i = 0; i <" + str(count_h)  + " ; ++i) { \n")
        self.template.write("for (unsigned j = 0; j <" + str(count_v) + " ; ++j) { \n")
        ...
        self.template.write("table->rowAt(random_int(0,i))->setStyleClass(random_string(30));\n")
        self.template.write("table->columnAt(j)->setStyleClass(random_string(20));\n")
        self.template.write("Wt::WTableCell *cell = table->elementAt(random_int(0,i), random_int(0, j));\n")
        self.template.write("cell->addWidget(std::make_unique<Wt::WText>(random_string(50)));\n")
        self.template.write("cell->setColumnSpan(random_int(0, j));\n")
        self.template.write("cell->setRowSpan(random_int(0, i));\n")
        self.template.write("WCssDecorationStyle style;\n")
        self.template.write("style.setBorder(WBorder(BorderStyle::" + str(random.choice(["None", "Hidden", "Dotted", "Dashed", "Solid", "Double", "Groove", "Ridge", "Inset", "Outset"])) + ", BorderWidth::" + str(random.choice(["Thin", "Medium", "Thick", "Explicit"])) + ", WColor(\"" + str(random.choice(["White", "Black", "Red", "DarkRed", "Green", "DarkGreen", "Blue", "DarkBlue", "Cyan", "DarkCyan", "Magenta", "Yellow", "DarkYellow", "Gray", "DarkGray", "LightGray", "Transparent"])) + "\")));\n")
        self.template.write("}\n")
        self.template.write("}\n")
        # Table View
        ...
        self.template.write("tableView->setColumnResizeEnabled(" + str(random.choice(["false", "true"])) + ");\n")
        self.template.write("tableView->setColumnAlignment(random_int(0, 10000), AlignmentFlag::" + str(random.choice(["Baseline", "Sub", "Super", "Top", "TextTop", "Middle", "bottom", "TextBottom", "Left", "Right", "Center", "Justify"]))  + ");\n")
        self.template.write("tableView->setHeaderAlignment(0, AlignmentFlag::" + str(random.choice(["Baseline", "Sub", "Super", "Top", "TextTop", "Middle", "bottom", "TextBottom", "Left", "Right", "Center", "Justify"]))  + ");\n")
        self.template.write("tableView->setAlternatingRowColors(" + str(random.choice(["false", "true"])) + ");\n")
        ...
        self.template.write("tableView->setSelectionMode(SelectionMode::" + str(random.choice(["None", "Single", "Extended"])) + ");\n")
        self.template.write("tableView->setEditTriggers(EditTrigger::" + str(random.choice(["None", "SingleClicked", "DoubleClicked", "SelectedClicked"])) + ");\n")
        ...
        self.template.write("tableView->setColumnHidden(random_int(0,10000), " + str(random.choice(["false", "true"])) + ");\n")
