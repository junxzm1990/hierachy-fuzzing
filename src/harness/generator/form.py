...
class PDF_FORM_API_MAP() : 
    ...
    def new_form(self, formID, cnt) :
        ...
        if len(FieldType) == 1 : 
            if FieldType != "4":
                self.template.write("int formID" + str(formID) + str(cnt) + " = FQL->NewFormField( L\""+Title_rand +"\", " + FieldType + "); \n")
        else :
            self.template.write("int formID" + str(formID) + str(cnt) + " = FQL->NewFormField( L\""+Title_rand +"\", " + FieldType[0] + "); \n")
            # API SetFormFieldChoiceType(formID, ChoiceType(0-4))
            SetFormFieldChoiceType_arg_1 = "SetFormFieldChoiceType_ChoiceType" + str(formID) + str(cnt)
            ...
            self.template.write("FQL-> SetFormFieldChoiceType(formID"+str(formID)+str(cnt)+", " + SetFormFieldChoiceType_arg_1 + ");\n")
        return FieldType
    def set_form_chk_style(self, formID, cnt) :
        # API SetFormFieldCheckStyle(formID, CheckStyle(0-7), Position(0-2))
        SetFormFieldCheckStyle_arg_1 = "SetFormFieldCheckStyle_CheckStyle" + str(formID) + str(cnt)
        SetFormFieldCheckStyle_arg_2 = "SetFormFieldCheckStyle_Position" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldCheckStyle(formID"+str(formID)+str(cnt)+", " + SetFormFieldCheckStyle_arg_1 + ", " +  SetFormFieldCheckStyle_arg_2 + "); \n")
    def set_form_choice_sub (self, formID, cnt, sub_cnt) :
        for i in range(0, int(sub_cnt)) : 
            letters = string.ascii_lowercase
            Title_rand = ''.join(random.choice(letters) for i in range(5))
            self.template.write("int formID" + str(formID) + str(cnt) + str(i) + "choice = FQL -> AddFormFieldChoiceSub(formID" + str(formID) + str(cnt) + ", L\""+Title_rand+"\", L\"" +Title_rand+"\"); \n")
    def set_form_format_mode(self) :
        # API SetFormFieldFormatMode(NewFormatMode)
        self.template.write("int SetFormFieldFormatMode_NewFormatMode=(int)0; \n")
        self.template.write("if (bytes_read - index >= sizeof(int)) { \n")
        self.template.write("SetFormFieldFormatMode_NewFormatMode = *(int*)(buffer+index); \n")
        self.template.write("if (SetFormFieldFormatMode_NewFormatMode != 0 || SetFormFieldFormatMode_NewFormatMode != 15 ) {\n")
        self.template.write("SetFormFieldFormatMode_NewFormatMode = (rand() > RAND_MAX/2) ? 0 : 15; \n")
        self.template.write("}else{ \n")
        ...
        self.template.write("exit(0); \n")
        self.template.write("} \n")
        self.template.write("FQL->SetFormFieldFormatMode(SetFormFieldFormatMode_NewFormatMode); \n") 
    # 2nd Necessay -------------------------------------------
    def set_form_visibility(self,formID, cnt) : 
    # API SetFormFieldVisible(formID, Visible(0-1))
        SetFormFieldVisible_arg_1 = "SetFormFieldVisible_Visible" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldVisible(formID"+str(formID)+str(cnt)+", "+ SetFormFieldVisible_arg_1 + "); \n") 
    def add_set_form_font(self, formID, cnt) :
        # API AddStandardFont(StandardFontID(0-13))
        AddStandardFont_arg_1 = "AddStandardFont_StandardFontID" + str(formID) + str(cnt)
        ...
        self.template.write("int FontID"+str(formID)+str(cnt)+"=FQL->AddStandardFont(" + AddStandardFont_arg_1 + "); \n")
        # API SetTextSize(TextSize(double))
        SetTextSize_arg_1 = "SetTextSize_TextSize" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->AddFormFont(FontID"+str(formID)+str(cnt)+"); \n")
        self.template.write("FQL->SetFormFieldFont(formID"+str(formID)+str(cnt)+", FQL->GetFormFontCount()); \n")
        # API SetFormFieldTextSize(formID, NewTextSize(double))
        SetFormFieldTextSize_arg_1 = "SetFormFieldTextSize_NewTextSize" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldTextSize(formID"+str(formID)+str(cnt)+", " + SetFormFieldTextSize_arg_1 + "); \n")
    def set_form_value(self, formID, cnt) :
        letters = string.ascii_lowercase
        Title_rand = ''.join(random.choice(letters) for i in range(5))
        self.template.write("FQL->SetFormFieldValue(formID"+str(formID)+str(cnt)+",  L\""+Title_rand +"\"); \n")
    def set_form_bounds(self, formID, cnt) :
        # API SetFormFieldBounds(formID, Left, Top, Width, Height)
        SetFormFieldBounds_arg_1 = "SetFormFieldBounds_Left" + str(formID) + str(cnt)
        SetFormFieldBounds_arg_2 = "SetFormFieldBounds_Top" + str(formID) + str(cnt)
        SetFormFieldBounds_arg_3 = "SetFormFieldBounds_Width" + str(formID) + str(cnt)
        SetFormFieldBounds_arg_4 = "SetFormFieldBounds_Height" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldBounds(formID"+str(formID)+str(cnt)+"," +  SetFormFieldBounds_arg_1 + " ,"+ SetFormFieldBounds_arg_2 +", " +  SetFormFieldBounds_arg_3 + ", " + SetFormFieldBounds_arg_4  + "); \n")
    def set_form_align(self, formID, cnt) :
        # API SetFormFieldAlignment(formID, Alignment(0-2))
        SetFormFieldAlignment_arg_1 = "SetFormFieldAlignment_Alignment" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldAlignment(formID"+str(formID)+str(cnt)+", " + SetFormFieldAlignment_arg_1 + " ); \n")

    # 3rd Necessay ----------------------------------------------
    def set_form_color(self, formID, cnt) :
        # border
        # API SetFormFieldBorderColor(formID, Red, Green, Blue)
        SetFormFieldBorderColor_arg_1 = "SetFormFieldBorderColor_Red" + str(formID) + str(cnt)
        SetFormFieldBorderColor_arg_2 = "SetFormFieldBorderColor_Green" + str(formID) + str(cnt)
        SetFormFieldBorderColor_arg_3 = "SetFormFieldBorderColor_Blue" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldBorderColor(formID" + str(formID) + str(cnt) + ", " + SetFormFieldBorderColor_arg_1 + ", " + SetFormFieldBorderColor_arg_2  +  ", " +  SetFormFieldBorderColor_arg_3 +  "); \n")
        # background
        # API SetFormFieldBackgroundColor(formID, Red, Green, Blue)
        SetFormFieldBackgroundColor_arg_1 = "SetFormFieldBackgroundColor_Red" + str(formID) + str(cnt)
        SetFormFieldBackgroundColor_arg_2 = "SetFormFieldBackgroundColor_Green" + str(formID) + str(cnt)
        SetFormFieldBackgroundColor_arg_3 = "SetFormFieldBackgroundColor_Blue" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldBackgroundColor(formID" + str(formID) + str(cnt) + "," + SetFormFieldBackgroundColor_arg_1 +  ", "  +  SetFormFieldBackgroundColor_arg_2  + ", " +  SetFormFieldBackgroundColor_arg_3 + "); \n")
    def set_form_border_style(self, formID, cnt) :
        ...
        SetFormFieldBorderStyle_arg_1 = "SetFormFieldBorderStyle_Width" + str(formID) + str(cnt)
        SetFormFieldBorderStyle_arg_2 = "SetFormFieldBorderStyle_Style" + str(formID) + str(cnt)
        SetFormFieldBorderStyle_arg_3 = "SetFormFieldBorderStyle_DashOn" + str(formID) + str(cnt)
        SetFormFieldBorderStyle_arg_4 = "SetFormFieldBorderStyle_DashOff" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldBorderStyle(formID" + str(formID) + str(cnt) + "," + SetFormFieldBorderStyle_arg_1 + ", "+SetFormFieldBorderStyle_arg_2 +","+ SetFormFieldBorderStyle_arg_3 +", " + SetFormFieldBorderStyle_arg_4 + " ); \n")
    def set_form_hlight(self, formID, cnt) :
        # API SetFormFieldHighlightMode(formID, newMode(0-3))
        SetFormFieldHighlightMode_arg_1 = "SetFormFieldHighlightMode_NewMode" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldHighlightMode(formID" + str(formID)+str(cnt) + ", " + SetFormFieldHighlightMode_arg_1  + "); \n")
    def set_form_icon(self, formID, cnt) :
        # API SetFormFieldIcon(formID, IconType(0-2), CaptureID(int))
        SetFormFieldIcon_arg_1 = "SetFormFieldIcon_IconType" + str(formID) + str(cnt)
        ...
        self.template.write("FQL->SetFormFieldIcon(formID" + str(formID) + str(cnt) + ", "+SetFormFieldIcon_arg_1+", FQL->CapturePage(1)) ; \n" ) 
    def form_jsa_weblk(self, formID, cnt) :
        letters = string.ascii_lowercase
        JS_rand = ''.join(random.choice(letters) for i in range(5))
        self.template.write("FQL->FormFieldJavaScriptAction(formID"+str(formID)+str(cnt)+", L\"U\",L\""+JS_rand+"\" ); \n")
    def set_form_caption(self, formID, cnt) :
        letters = string.ascii_lowercase
        CP_rand = ''.join(random.choice(letters) for i in range(5))
        self.template.write("FQL->SetFormFieldCaption(formID" + str(formID) + str(cnt) + ", L\""+ CP_rand +"\" ); \n")
    ...
    def set_form_radio_dependency (self) : 
        if len(self.radio_sub_group) > 0 :
            for i in self.radio_sub_group.items() : 
                ...
                self.template.write("int formID"+name+"main"+" = FQL->NewFormField(L\""+Title_rand+"\", 4); \n")
                for j in range(0, sub_cnt):
                    # add sub form to main
                    self.template.write("int formID"+name+str(j)+" = FQL->AddFormFieldSub(formID"+name+"main"+", L\""+Title_rand+str(j)+"\"); \n")
